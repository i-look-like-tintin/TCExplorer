...
// dp4df Data File Patterns
define('DP4DF_FILE_PATTERNS', [
    'current' => [
        'pattern' => 'dp4df_historical_*.nc',
        'ensemble_members' => 100,
        'time_period' => '1990-2020'
    ],
    '2k' => [
        'pattern' => 'dp4df_2k_warming_*.nc',
        'ensemble_members' => 90,
        'time_period' => '2040-2070'
    ],
    '4k' => [
        'pattern' => 'dp4df_4k_warming_*.nc',
        'ensemble_members' => 90,
        'time_period' => '2070-2100'
    ]
]);
